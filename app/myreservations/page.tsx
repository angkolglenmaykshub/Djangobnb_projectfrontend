                ...
                <div className="space-y-4">
                    <div className="p-5 grid grid-cols-1 md:grid-cols-4 gap-4 shadow-md border border-gray-300">
                        <div className="col-span-1">
                            <div className="relative overflow-hidden aspect-square round-xl">
                                <Image
                                    fill
                                    src="/beach_1.jpg"
                        ...
                        <div className="col-span-1 md:col-span-3">
                            <h2 className="mb-4 text-xl">Proper name</h2>
                            <p className="mb-2"><strong>Check in date: </strong>09/11/2025</p>
                            <p className="mb-2"><strong>Check out date: </strong>11/11/2025</p>
